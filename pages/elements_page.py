...
from locators.elements_page_locators import ButtonsPageLocators, CheckBoxPageLocators, DynamicPropertiesPageLocators, LinksPageLocators, RadioButtonPageLocators, TextBoxPageLocators, UploadAndDownloadPageLocators, WebTablePageLocators
...
class ButtonsPage(BasePage):
    ...
    def click_on_different_button(self, type_click):
        if type_click == "double":
            ...
            return self.check_clicked_on_the_buttons(self.locators.SUCCESS_DOUBLE)

        if type_click == "right":
            self.action_right_click(self.element_is_visible(self.locators.RIGHT_CLICK_BUTTON))
            return self.check_clicked_on_the_buttons(self.locators.SUCCESS_RIGHT_CLICK)

        if type_click == "click":
            self.element_is_visible(self.locators.CLICK_ME_BUTTON).click()
            return self.check_clicked_on_the_buttons(self.locators.SUCCESS_CLICK_ME)

    @allure.step('check clicked button')    
    def check_clicked_on_the_buttons(self, element):
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = rf'C:\Users\kimma\github\automation_qa_course\filetest{random.randint(0,999)}.jpeg'
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_apear_of_button(self):
        try:
