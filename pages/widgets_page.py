    ...
    def check_accordian(self, accordian_num):
        ...
        try:
            section_content = self.element_is_visible(
                accordian[accordian_num]["content"]
            )
...
class ToolTipsPage(BasePage):
    ...
    def check_tool_tips(self):
        ...
        tool_tip_text_contrary = self.get_text_from_tool_tips(
            self.locators.CONTARY_LINK, self.locators.TOOL_TIP_CONTARY_LINK
        )
        tool_tip_text_section = self.get_text_from_tool_tips(
            self.locators.SECTION_LINK, self.locators.TOOL_TIP_SECTION_LINK
        )
        return (
