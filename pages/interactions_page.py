...
from locators.interactions_locators import DraggablePageLocators, DroppablePageLocators, ResizablePageLocators, SelectablePageLocators, SortablePageLocators
