...
class TestWidgets:
    ...
    class TestDatePickerPage:
        ...
        def test_change_date(self, driver):
            ...
            assert (
                value_date_before != value_date_after
            ), "The date have not been changed"
    ...
    class TestTabsPage:
        ...
        def test_tabs(self, driver):
            ...
            assert (
                what_button == "What" and what_content != 0
            ), "The tab was not pressed or the text is missing"
            assert (
                origin_button == "Origin" and origin_content != 0
            ), "The tab was not pressed or the text is missing"
            assert (
                use_button == "Use" and use_content != 0
            ), "The tab was not pressed or the text is missing"
    ...
    class TestToolTips:
        ...
        def test_tool_tips(self, driver):
            ...
            assert (
                button_text == "You hovered over the Button"
            ), "hover missimg or incorrect content"
            assert (
                field_text == "You hovered over the text field"
            ), "hover missimg or incorrect content"
            assert (
                contrary_text == "You hovered over the Contrary"
            ), "hover missimg or incorrect content"
            assert (
                section_text == "You hovered over the 1.10.32"
            ), "hover missimg or incorrect content"
